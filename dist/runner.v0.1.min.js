...
var game=function(){var t,e,n,i,o,s=!1,r=0,a=0,c=[],h=0,p=new Scene,l=new Scene,u=function(){s=!1,r=0,l.reset(),p.reset(),l.transform(canvas.width),p.transform(2*canvas.width),window.requestAnimationFrame(I,canvas)},f=function(){s=!0,a=r>a?r:a},y=function(){e=new Scene,e.setXSpeed(-.8),e.image(IMAGES.bg,0,0,canvas.width,canvas.height),n=new Scene,n.setXSpeed(-.8),n.image(IMAGES.bg,0,0,canvas.width,canvas.height),n.transform(canvas.width,0),i=new Scene,i.setXSpeed(-4),i.image(IMAGES.ground,0,220,canvas.width+10,canvas.height-220),o=new Scene,o.setXSpeed(-4),o.image(IMAGES.ground,0,220,canvas.width+10,canvas.height-220),o.transform(canvas.width,0)},m=function(){t=new Runner,t.animation(IMAGES.guagua,50,172,31,49,61,98,8,5),t.setGraviry(.4),t.setJumpSpeed(-10)},d=function(){y(),m(),g(),document.onkeydown=function(e){32!=e.keyCode||s||t.jump()},document.onkeyup=function(t){32==t.keyCode&&s&&u()}},x=function(){var t=new Scene
return t.setXSpeed(-4),c.push(t),t},g=function(){w(),w()},w=function(){l=p,0!=c.length&&(p=c[h],p.reset(),p.transform(canvas.width+l.getTransform().x,0),++h>=c.length&&(h=0))},S=function(){context.fillStyle="white",context.font="15px bold",context.drawImage(LL.getImages().score,3,3,20,20),context.fillText(r,25,20),context.drawImage(LL.getImages().hiscore,canvas.width-80,3,20,20),context.fillText(a,canvas.width-55,20),s&&(context.font="18px bold",context.fillText("press SPACE to try again",180,100))},v=function(){e.loop(),n.loop(),i.loop(),o.loop(),p.run(),l.run(),l.getTransform().x<-canvas.width&&w(),t.update(),t.draw(),r+=1,L()&&f()},I=function(){s||(v(),S(),requestAnimationFrame(I))},L=function(){return!(!t.collide(p)&&!t.collide(l))}
return{init:d,loop:I,newScene:x,start:u,getImages:LL.getImages,addImages:LL.addImages,loadImageAndRun:LL.loadImageAndRun,speed:-4}}()
