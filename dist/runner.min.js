...
return!1},LL.inheritPrototype(Runner,Scene),Runner.prototype.jump=function(){this.isInAir()||(this.setYSpeed(this.jumpSpeed),MUSIC.jump.play(),this.secondJump=!0),this.secondJump&&this.ySpeed>.5*this.jumpSpeed&&(this.setYSpeed(.8*this.jumpSpeed),MUSIC.jump2.play(),this.secondJump=!1)},Runner.prototype.isInAir=function(){return this.getTransform().y<0},Runner.prototype.update=function(){this.isInAir()||this.ySpeed<0?this.ySpeed+=this.g:(this.ySpeed=0,this.reset()),Scene.prototype.update.call(this)},Runner.prototype.setGraviry=function(t){this.g=t},Runner.prototype.setJumpSpeed=function(t){this.jumpSpeed=t},LL.RunnerGame=function(){var t,e,n,i,o,s=!1,r=0,a=0,c=[],h=0,u=new Scene,p=new Scene,l=function(){s=!1,r=0,p.reset(),u.reset(),p.transform(canvas.width),u.transform(2*canvas.width),MUSIC.bgm.play(),window.requestAnimationFrame(L,canvas)},m=function(){s=!0,a=r>a?r:a},f=function(){e=new Scene,e.setXSpeed(-.8),e.image(IMAGES.bg,0,0,canvas.width,canvas.height),n=new Scene,n.setXSpeed(-.8),n.image(IMAGES.bg,0,0,canvas.width,canvas.height),n.transform(canvas.width,0),i=new Scene,i.setXSpeed(-4),i.image(IMAGES.ground,0,220,canvas.width+10,canvas.height-220),o=new Scene,o.setXSpeed(-4),o.image(IMAGES.ground,0,220,canvas.width+10,canvas.height-220),o.transform(canvas.width,0)},d=function(){t=new Runner,t.animation(IMAGES.guagua,50,172,31,49,61,98,8,5),t.setGraviry(.4),t.setJumpSpeed(-10)},y=function(){document.onkeydown=function(e){e.keyCode&&!s&&t.jump()},document.ontouchstart=function(e){s||t.jump()},document.onmousedown=function(e){s?l():t.jump()},document.ontouchend=function(t){s&&l()},document.onkeyup=function(t){32==t.keyCode&&s&&l()}},g=function(){f(),d(),x(),y()},w=function(){var t=new Scene
return t.setXSpeed(-4),c.push(t),t},x=function(){for(;c.length<=2;)w()
S(),S()},S=function(){p=u,u=c[h],u.reset(),u.transform(canvas.width+p.getTransform().x,0),++h>=c.length&&(h=0)},v=function(){context.fillStyle="white",context.font="15px bold",context.drawImage(LL.getImages().score,3,3,20,20),context.fillText(r,25,20),context.drawImage(LL.getImages().hiscore,canvas.width-80,3,20,20),context.fillText(a,canvas.width-55,20),s&&(context.font="18px bold",context.fillText("press SPACE to try again",180,100))},I=function(){e.loop(),n.loop(),u.run(),p.run(),p.getTransform().x<-canvas.width&&S(),i.loop(),o.loop(),t.update(),t.draw(),r+=1,R()&&m()},L=function(){s||(I(),v(),requestAnimationFrame(L))},R=function(){return!(!t.collide(u)&&!t.collide(p))}
return{init:g,loop:L,newScene:w,start:l,getImages:LL.getImages,addImages:LL.addImages,loadImageAndRun:LL.loadImageAndRun,speed:-4}}
